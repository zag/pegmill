// Approach inspired by peggyjs/peggy#337 (quadristan, MIT)
// https://github.com/peggyjs/peggy/pull/337
    ...
    var walk = visitor.build({
      rule_ref: function(node) {
        ...
        if (!asts.findRule(ast, mangled)) {
          /* Build paramMap: { ParamName: ExprNode, ... } */
          var paramMap = {};
          arrays.each(tmpl.params, function(param, i) {
            var arg = node.args[i];
            paramMap[param] = typeof arg.value === "string"
              ? { type: "rule_ref", name: arg.value }
              : arg.value;
          });
